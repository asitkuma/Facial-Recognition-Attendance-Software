...
class student:
    def __init__(self, root):
        ...
        img = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\student_1.jpg")
        ...
        img2 = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\student_2.jpg")
        ...
        img3 = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\student3.jpeg")
        ...
        img4 = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\fancy.jpg")
        ...
        left_frame_image = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\student_image.jpg")
        left_frame_image = left_frame_image.resize((758, 130), Image.ANTIALIAS)
        ...
        right_frame_image = Image.open(
            r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\right_me_fit_kar.jpg")
        right_frame_image = right_frame_image.resize(
            (748, 130), Image.ANTIALIAS)
    ...
    def ischeck(self):
        if(self.dep.get() == "Select Department" or self.cour.get() == "Select Your Course" or self.yr.get() == "Select Your Year" or self.sem.get() == "Semester" or self.s_id.get() == "" or self.s_name.get() == "" or self.Blogs.get() == "" or self.R_no.get() == "" or self.gender.get() == "" or self.dob.get() == "" or self.address.get() == "" or self.p_number.get() == "" or self.email.get() == "" or self.t_name.get() == ""):
            ...
            try:
                ...
                messagebox.showinfo(
                    "error", "some error occured", parent=self.root)
            ...
            try:
                ...
                while True:
                    ...
                    if var1 is not None:
                        ...
                        file_path = "userphotos/user." + str(id)+"."+str(count)+".jpg"
