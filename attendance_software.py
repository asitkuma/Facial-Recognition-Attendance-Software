...
class Attendance_lelo:
    def __init__(self,root):
        ...
        bg_image=bg_image.resize((1580,780),Image.ANTIALIAS)
        ...
        img=Image.open("attendance_software_1.jpeg")
        ...
        img2=Image.open("attendance_software_2.jpeg")
        ...
        #photo
        inside_image=Image.open("inside_attendance.jpg")
        inside_image=inside_image.resize((1000,500),Image.ANTIALIAS)
