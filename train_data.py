...
class Train_Image():
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\Asit\OneDrive\Desktop\Tkinter_project\train_page_data.png")
        img=img.resize((1520,400),Image.ANTIALIAS)
        #instance variable
        self.photoimage=ImageTk.PhotoImage(img)
        label=Label(self.root,image=self.photoimage)
        label.place(x=0,y=0,width=1520,height=350)

        img2=Image.open(r"train_data_2nd.jpg")
        img2=img2.resize((1520,400),Image.ANTIALIAS)
